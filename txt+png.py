...
#
# def main(image_path, labels_path, output_path):
#     # 读取图像
...
#     image_path = '/home/solid/TZ/PETDet-dev/data/images_0.4/images_0.4/1939.png'
#     labels_path = '/home/solid/TZ/PETDet-dev/work_dirs/fair1m_test3_txt0.6/1939.txt'
#     output_path = '/home/solid/TZ/PETDet-dev/work_dirs/1939_annotated.png'
#
#     # 执行主函数
#     main(image_path, labels_path, output_path)
...
#             labels_path = os.path.join(input_labels_folder, filename.replace(".png", ".txt"))
#
#             # 读取图像
#             image = cv2.imread(image_path)
#             if image is None:
...
# if __name__ == "__main__":
#     # 替换为你的图像路径、标签文件路径和输出路径
#     input_image_folder = '/home/solid/TZ/PETDet-dev/data/images_0.4/images_0.4'
#     input_labels_folder = '/home/solid/TZ/PETDet-dev/work_dirs/fair1m_test3_txt0.6'
#     output_folder = '/home/solid/TZ/PETDet-dev/work_dirs/output'
#
#     # 执行主函数
