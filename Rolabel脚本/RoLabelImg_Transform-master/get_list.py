...
parser.add_argument("--input_path", type=str, default='/home/solid/my_tools/Rolabel脚本/RoLabelImg_Transform-master/txt', help="")
...
if args.model == 'txt_to_xml':
    ...
    dir_list = [dir for dir in os.listdir(txt_path)]
